...
//	public String doWrite(Board board, MultipartFile[] files) {
	...
	public void download(@PathVariable int fileIdx, HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		BoardFile file = boardService.findBoardFileByFileIdx(fileIdx);
