	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow">
			<sec:authorize access="isAnonymous()">
				<a href="/legacy-spring-board-d/resources/login.html" id="login" role="button" aria-expanded="false">
					<span class="mr-2 d-none d-lg-inline text-gray-600 small">로그인</span>
				</a>
	            &nbsp;
	            <a href="/legacy-spring-board-d/resources/register.html" id="join" role="button" aria-expanded="false">
			...
			<sec:authorize access="isAuthenticated()">
				...
				<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
					...
					<a class="dropdown-item" href="/legacy-spring-board-d/logout">
